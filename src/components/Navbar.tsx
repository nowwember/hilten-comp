    ...
    <nav className="glass border-b sticky top-0 z-20">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 sm:gap-3 text-sm">
          ...
          <Link href="/exams/oge" className="px-3 py-2 rounded-lg hover:bg-slate-900/5 dark:hover:bg-white/5 transition">ОГЭ</Link>
          <Link href="/exams/ege" className="px-3 py-2 rounded-lg hover:bg-slate-900/5 dark:hover:bg-white/5 transition">ЕГЭ</Link>
